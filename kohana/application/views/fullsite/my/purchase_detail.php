<form id="fcontent" name="fcontent" action="/my/purchase/detail" method="post">
<?php include "my_menu.php"; ?>
	<div class="col2 col-lg-10 col-md-10">
		<h4><?php echo I18n::get('order') . ' #' . $order_id ?></h4><hr>
		<div class="alert alert-info alert-block"><b><?php echo I18n::get('order_status') . ": $order_status" ?></b></div>
		...
		<div class="col-lg-12 col-md-12 panel panel-default">
			<div class="panel-body">
				<div class="col-lg-8 col-md-8">
					...
					<div class="col-lg-4 col-md-4">
						...
						<?php echo HTML::chars($array_order['shipping_service']) ?>
						<?php
						}
						?>
					</div>
			...
			if (in_array($array_order['order_status'], array(1, 2)) AND array_key_exists(strtolower($currency), $cfg_crypto))
			{
				$total = $array_order['new_total'] . ' ' . $currency;

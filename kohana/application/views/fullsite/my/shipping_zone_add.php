<form class="form-horizontal" id="fcontent" name="fcontent" action="/my/shipping/shipping_zone_<?php echo $action ?>" method="post">
	...
	<div class="col80 content-right">
		...
		<div class="form-group row">
			...
			<div class="col-lg-5 col-md-6 error"><span id="error_country"></span><?php echo $errors['cb'] ?></div>
		</div>
		<p class="text-center"><br><input class="btn btn-default" name="<?php echo $action ?>" type="submit" value="<?php echo I18n::get('submit') ?>" /></p>
	</div>
...
$(document).ready(function() {
	...
	jQuery.validator.addMethod("check_country",function(value) {
		return ($('.checkbox:checked').length > 0);
	}, "Please select at least one country/region for this shipping zone");
